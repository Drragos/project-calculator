...
const calcBodyClass =
  "max-w-lg rounded overflow-hidden shadow-2xl bg-gray-700 bg-opacity-75 flex";
...
const previousNumberClass =
  "flex max-w-lg h-1/3 pb-5 pt-1 text-gray-500 text-xs";
...
function addClasses(button) {
  ...
  const btnOprClass = "hover:bg-blue-500 border-blue-500";
  ...
  if (button.classList.contains("number")) {
    ...
    btnOprClass.split(" ").forEach((cls) => button.classList.add(cls));
